            ...
            <div class="card-inner-group">
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist">
                        ...
                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Linea de producto</span></div>
                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">Marca</span></div>
                            
                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">Tipo de vehiculo</span></div>
                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">Descripcion</span></div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="?pagina=productos/mostrar&id_pro=<?=$producto->id_pro?>"><em class="icon ni ni-activity-round"></em><span>Actualizar </span></a></li>
                                                        <li><a href="?pagina=productos/eliminar&id_pro=<?=$producto->id_pro?>"><em class="icon ni ni-trash"></em><span>Eliminar </span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li> -->
